    ...
    <FadeRR top distance="10px">
      <div className={styles.view_content_container}>
        ...
        <p className={dawnStyles}>
          ...
          sympathisers of the so-called “Bangla Desh.” Sheikh Muhammad Abdullah-
          Chief Minister of Jammu and Kashmir- also admonished perils of Indian
          jingoism, claiming that in expressing sympathy for “Bangla Desh,”
          India itself had forgotten its denial of the right of
          self-determination to the people of Kashmir, since the past 23 years.
          At the same time, a German newsman was reported to have revealed the
        ...
        <p className={dawnStyles}>
          ...
          army under the command of General Manekshaw. Then, a few days later,
          it was reported that the Indian Army patrol had apprehended 16
          Pakistani nationals from the area opposite Comila and acquired their
        ...
        <p className={dawnStyles}>
          <span className={jangStyles}>
            ...
            machine-gun and mortar fire into East Pakistan, from across the West
            Bengal-Assam border. 11 June: all instigators in East Pakistan were
            foreign funded and supported. 12 June: We couldnt see the inferior
            muslims becoming rulers, say Hindu families from East Bengal now in
            India. 13 June: Indian Army shot at muslims wanting to enter East
            pakistan. 15 June: India will start guerilla warfare in August due
            to monsoon, Hindus populating the Mukti bahini to conspire to finish
            Pakistan. 21 June: East Pakistan border filled with Indian Army’s
        ...
        <p className={dawnStyles}>
          ...
          On June 26, India’s radio propaganda about the demolition of the
        ...
        <p className={dawnStyles}>
          ...
          On June 3, Indian authorities were reported to have initiated a
          ...
          By 9 June, more people had started entering western districts of East
          Pakistan from across the border. Around 150 people were reported at
          Rajshahi, 500 at Dinajpur and 120 at Saikhira. The next day, Governor
        ...
        <p className={dawnStyles}>
          ...
          announced that India harboured no intention of permitting DPs from
          East Pakistan to settle in her country or return to East Pakistan. She
        ...
        <p className={dawnStyles}>
          ...
          with ecstatic glee upon returning to their surroundings. On 16 June,
          the Pakistan Government decided to formulate a proposal seeking
          India’s cooperation to facilitate the return and rehabilitation of DPs
        ...
        <p className={dawnStyles}>
          ...
          to minority communities were stressed to express no hesitation, as
        ...
        <p className={dawnStyles}>
          <span className={jangStyles}>
            ...
            to answer any attack says Tikka Khan. Situation in East Pakistan
            returning to normal]. 17 June: Delay in the announcement of transfer
            of power expected, Yahya Khan busy.
          </span>
        </p>
        ...
        <p className={dawnStyles}>
          ...
          visit of U.N. High Commissioner for Refugees, Prince Sadruddin Aga
          Khan to Pakistan. Another 2000 DPs returned to Dinajpur district from
          India.
        </p>
        ...
        <p className={dawnStyles}>
          ...
          long-awaited national broadcast, he also declared that task of framing
          the constitution by the Assembly was not feasible, and that the
          constitution would be prepared by a group of experts. By-elections
          would be organised to fill vacancies of the disqualified MNAs and
          MPAs.
        </p>
      </div>
    </FadeRR>
